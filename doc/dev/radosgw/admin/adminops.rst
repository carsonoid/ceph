...
and returned in the response. If only one of ``access-key`` or ``secret`` is
provided, the ommitted key will be automatically generated. By default, a 
generated key is added to the keyring without replacing an existing keypair.
...
:Description: Generate a new secret key and add to the existing keyring.
:Type: Boolean
:Example: True
:Required: No
...
:Description: Generate the subuser access key automatically.
:Type: Boolean
:Example: True
:Required: No
...
will be swift type. If only one of ``access-key`` or ``secret`` is
provided, the ommitted key will be automatically generated. By default, a 
generated key is added to the keyring without replacing an existing keypair.
If ``access-key`` is specified and refers to an existing key owned by the user
...
:Description: Keys associated with this user account.By default contains S3 keys.
:Type: Container
